let headerBar = document.getElementById("toggle_my_header");
let searchBar = document.querySelector(".search_bar_input");
let body = document.body;
let homeContainer = document.querySelector(".center_container");

let seeMoreBtn = document.getElementById("see_more_center_responsive");
let favoriteContainer = document.getElementById("responsive_favoris");
let shawProfileBtn = document.querySelector(".me");
let btnMessageArea = document.querySelector("#btn_toggle_message_box");
let messageArea = document.querySelector(".sms_container");
...
let dynamicSearch = () => {
  let valueSearch = document
    .getElementById("search_message")
    .value.toUpperCase();
  let boxItems = document.querySelectorAll(".message_profil_item");

  let title = document.getElementsByClassName("name_pro");
